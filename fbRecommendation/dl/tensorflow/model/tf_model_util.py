...
from fbRecommendation.dl.tensorflow.model.tfhub_text_model_constant import \
    MAP_NAME_TO_HANDLE, MAP_MODEL_TO_PROCESSES


class TFModelUtil(ModelUtil):
    @staticmethod
    def prepare_embedding_model(embedding: str,
        ...
        if embedding == 'BERT':
            tfhub_handle_encoder = MAP_NAME_TO_HANDLE[pretrain_model]
            tfhub_handle_preprocess = MAP_MODEL_TO_PROCESSES[pretrain_model]
